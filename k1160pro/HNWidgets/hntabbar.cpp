...
HNTabBar::HNTabBar(QWidget *parent) :
    QTabBar(parent)
{
    setFocusPolicy(Qt::NoFocus);
}

void HNTabBar::tabPixmap(int index, QImage& icon, QImage& iconSel)
{
...
void HNTabBar::setTabPixmap(int index, const QString &icon, const QString& iconSel)
{
...
void HNTabBar::paintEvent(QPaintEvent * e)
{
